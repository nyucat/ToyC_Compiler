...
if (MSVC)
    target_compile_options(test_ir PRIVATE /W4 /O2 /GL)
    target_compile_options(test_optimizer PRIVATE /W4 /O2 /GL)
    if (TARGET test_abc_pipeline)
        target_compile_options(test_abc_pipeline PRIVATE /W4 /O2 /GL)
    endif()
    if (IPO_SUPPORTED)
        set_target_properties(test_ir PROPERTIES INTERPROCEDURAL_OPTIMIZATION TRUE)
        set_target_properties(test_optimizer PROPERTIES INTERPROCEDURAL_OPTIMIZATION TRUE)
    endif()
else()
    target_compile_options(test_ir PRIVATE -Wall -Wextra -pedantic ${TOYC_PERF_FLAGS})
    target_compile_options(test_optimizer PRIVATE -Wall -Wextra -pedantic ${TOYC_PERF_FLAGS})
    if (IPO_SUPPORTED)
        set_target_properties(test_ir PROPERTIES INTERPROCEDURAL_OPTIMIZATION TRUE)
        set_target_properties(test_optimizer PROPERTIES INTERPROCEDURAL_OPTIMIZATION TRUE)
    endif()
